...
// FRC Northern Michigan Fall 2017
//RJ-Libraries
...
public:
	...
	void TeleopPeriodic() {
		...
		//double DRIV_CONTROL_LX = Drivestick.GetRawAxis(0), Drivestick.GetRawAxis(1) = Drivestick.GetRawAxis(1);
		//double Drivestick.GetRawAxis(2) = Drivestick.GetRawAxis(2), Drivestick.GetRawAxis(3) = Drivestick.GetRawAxis(3) ;
...
//				double com = 0.8;
//				double cmd = com *Shooter0.Get() + (1.0-com) * err * ShootKP;
//				Shooter0.Set(-cmd);
//
//
...
#define AR3_END 6
	...
	void SmartDashboardUpdate() {
		...
		SmartDashboard::PutNumber("ShootPPID ERROR", ShooterPID.GetError());
